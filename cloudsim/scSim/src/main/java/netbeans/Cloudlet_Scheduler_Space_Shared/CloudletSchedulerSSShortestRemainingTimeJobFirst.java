...
package netbeans.Cloudlet_Scheduler_Space_Shared;
...
public class CloudletSchedulerSSShortestRemainingTimeJobFirst extends CloudletScheduler{
	...
	protected int usedPes;
        ...
        private boolean sortedExec = false, sortedWaiting = false;
	 ...
	 * @post $none
	 */
	public CloudletSchedulerSSShortestRemainingTimeJobFirst() {
		super();
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		getCloudletExecList().removeAll(toRemove);
                ...
                if(!sortedWaiting) {
                    Collections.sort(getCloudletWaitingList(), new  ResCloudletComparator());
                    sortedWaiting = true;
                }
